...
def render(count: int) -> str:
  ...
  <title id="title">{count_text} GitHub contributions in the last year</title>
  <desc id="desc">Public GitHub profile contribution total for Puneet-2005, refreshed daily by GitHub Actions.</desc>
  <defs>
  ...
  <g font-family="Consolas,Menlo,monospace">
    ...
    <g transform="translate(46 88)">
      ...
      <text x="24" y="171" fill="#39ff14" font-size="14" letter-spacing="2">LAST YEAR</text>
    </g>
    ...
    <g transform="translate(570 88)">
      ...
      <text x="176" y="108" fill="#e6edf3" font-size="15">LAST YEAR</text>
      <text x="22" y="139" fill="#6b7280" font-size="11" letter-spacing="2">SOURCE</text>
      <text x="176" y="139" fill="#e6edf3" font-size="15">GITHUB PUBLIC PROFILE</text>
